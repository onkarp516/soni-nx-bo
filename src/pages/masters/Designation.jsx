...
import { DTDesignationUrl } from "@/services/api";
import {
  createDesignation,
  findDesignation,
  updateDesignation,
    ...
    <div>
      ...
      >
        ...
        <Formik
          ...
          initialValues={{
            designationName:
              designationObject != null ? designationObject.name : "",
            designationCode:
              designationObject != null ? designationObject.code : "",
          }}
          validationSchema={Yup.object().shape({
            designationName: Yup.string()
              .trim()
