    ...
    axios({
      ...
      .then((response) => {
        ...
        if (res.responseStatus == 200) {
          ...
          setPerPage(perPage);
          setTotalRows(res.response.total);
          setLoading(false);
        } else if (res.responseStatus == 403) {
          setLoading(true);
          toast.success(res.message, {
            onClose: () => AuthenticationService.logout(),
          });
        } else {
          setLoading(true);
        }
      ...
      .catch((error) => {
        ...
        if (error.response.data.responseStatus == 403) {
          setLoading(true);
